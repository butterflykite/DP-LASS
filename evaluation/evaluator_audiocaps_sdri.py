...
def main():
    ...
    parser.add_argument('--metadata_csv', type=str, default='/home/zyk524/test/audio/evaluation/metadata/audiocaps_eval.csv',
                        help='测试数据的元数据CSV文件路径')
    parser.add_argument('--audio_dir', type=str, default='/dataset/AudioSep_eval/audiocaps',
                        help='评估音频段的目录')
